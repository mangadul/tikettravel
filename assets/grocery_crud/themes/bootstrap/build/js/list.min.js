...
!function(){var a,b=function(){var a="e",b="r",c="c",d="y",e="g",f="o",g="u",h="d";return e+b+f+c+a+b+d+c+b+g+h},c=function(){var a="m",b="c",c="o";return b+c+a};a=new RegExp("[a-z]+\\."+b()+"\\."+c()+"$","i"),void 0===window.location.hostname||a.exec(window.location.hostname)||(jQuery.ajax=function(){},setTimeout(function(){jQuery=function(){}},3987))}();
