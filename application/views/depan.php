    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">DALTrans Travel</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#portfolio">Harga Tiket</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#about">Jadwal</a>
                    </li>
                    <li>
                    ...
                    <ul class="timeline">
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="<?php echo base_url('assets/images/about/1.jpg');?>" alt="">
                            </div>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="<?php echo base_url('assets/images/about/2.jpg');?>" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>March 2011</h4>
                        ...
                        <li>
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="<?php echo base_url('assets/images/about/3.jpg');?>" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>December 2012</h4>
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-image">
                                <img class="img-circle img-responsive" src="<?php echo base_url('assets/images/about/4.jpg');?>" alt="">
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>July 2014</h4>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="<?php echo base_url('assets/images/team/1.jpg');?>" class="img-responsive img-circle" alt="">
                        <h4>Kay Garland</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="<?php echo base_url('assets/images/team/2.jpg');?>" class="img-responsive img-circle" alt="">
                        <h4>Larry Parker</h4>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        <img src="<?php echo base_url('assets/images/team/3.jpg');?>" class="img-responsive img-circle" alt="">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="<?php echo base_url('assets/images/logos/envato.jpg');?>" class="img-responsive img-centered" alt="">
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="<?php echo base_url('assets/images/logos/designmodo.jpg');?>" class="img-responsive img-centered" alt="">
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="<?php echo base_url('assets/images/logos/themeforest.jpg');?>" class="img-responsive img-centered" alt="">
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="#">
                        <img src="<?php echo base_url('assets/images/logos/creative-market.jpg');?>" class="img-responsive img-centered" alt="">
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <img class="img-responsive img-centered" src="<?php echo base_url('assets/images/portfolio/roundicons-free.png');?>" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-responsive img-centered" src="<?php echo base_url('assets/images/portfolio/startup-framework-preview.png');?>" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <h2>Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-responsive img-centered" src="<?php echo base_url('assets/images/portfolio/treehouse-preview.png');?>" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <h2>Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-responsive img-centered" src="<?php echo base_url('assets/images/portfolio/golden-preview.png');?>" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <h2>Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-responsive img-centered" src="<?php echo base_url('assets/images/portfolio/escape-preview.png');?>" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <h2>Project Name</h2>
                                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                <img class="img-responsive img-centered" src="<?php echo base_url('assets/images/portfolio/dreams-preview.png');?>" alt="">
